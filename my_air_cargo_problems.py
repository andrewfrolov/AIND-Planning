...
class AirCargoProblem(Problem):
    ...
    def actions(self, state: str) -> list:
        ...
        for action in self.actions_list:
            if not pos.issuperset(action.precond_pos):
                continue
            if not neg.issuperset(action.precond_neg):
                continue
    ...
    def result(self, state: str, action: Action):
        ...
        neg_set -= set(action.effect_add)

        new_state = FluentState(list(pos_set), list(neg_set))
